...
* **`latency_wan.csv` (1000 × 32):** A Zero-Shot generalization benchmark simulating Wide Area Network (WAN) conditions, characterized by higher base propagation latencies (100-250 ms) and route flapping events.
